# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in practice.
...
import practice
from practice import model, lib
...
base_config.model = practice.model
base_config.DBSession = practice.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "32562ea4-403a-41e8-b620-49e4613cfce1"
...
# Base url of github.
base_config.base_url = 'http://api.github.com'
