# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in tarsier.
...
base_config.model = tarsier.model
base_config.DBSession = tarsier.model.DBSession
